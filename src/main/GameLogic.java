...
public class GameLogic {
	 ...
	 *             might be called by Thread.sleep
	 */
	...
	void shoot() {
		...
		// } else {
		// distance =
		// BIGGEST_ID.subtract(target).add(targetNext).divide(MIDDLE);
		// }
	...
	/**
	 * calculates the next sector for an ID. This is needed to be able to shoot
